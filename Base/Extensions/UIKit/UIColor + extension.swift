...
//  Recipe Jar
//
//  Created by Othman Shahrouri on 29/12/2023.
//
...
extension UIColor {
  ...
  static let primary = UIColor(red: 0.498, green: 0.322, blue: 0.514, alpha: 1)
  static let secondary = UIColor(red: 0.93, green: 0.77, blue: 0.2, alpha: 1)
  static let navy = UIColor(red: 0.14, green: 0.16, blue: 0.27, alpha: 1)
  ...
  static let orange = #colorLiteral(red: 1, green: 0.6274509804, blue: 0.1568627451, alpha: 1)
  ...
  static let grey_100 = UIColor(red: 0.97, green: 0.97, blue: 0.97, alpha: 1)
  static let grey_200 = UIColor(red: 0.81, green: 0.82, blue: 0.84, alpha: 1)
  static let grey_300 = UIColor(red: 0.85, green: 0.85, blue: 0.85, alpha: 0.48)
  static let grey_400 = UIColor(red: 0.85, green: 0.85, blue: 0.85, alpha: 1)

  static let grey_500 = UIColor(red: 0.67, green: 0.67, blue: 0.67, alpha: 1)
  static let grey_600 = UIColor(red: 0.94, green: 0.94, blue: 0.94, alpha: 1)
  static let grey_700 = #colorLiteral(red: 0.3960784314, green: 0.4117647059, blue: 0.4901960784, alpha: 1)
  static let grey_800 = #colorLiteral(red: 0.2862745098, green: 0.3137254902, blue: 0.3882352941, alpha: 1)
  static let grey_900 = #colorLiteral(red: 0.2, green: 0.2235294118, blue: 0.3294117647, alpha: 1)
  static let grey_1000 = #colorLiteral(red: 0.3803921569, green: 0.368627451, blue: 0.5137254902, alpha: 1)
  static let grey_1100 = #colorLiteral(red: 0.8980392157, green: 0.8980392157, blue: 0.937254902, alpha: 1)
  ...
  static let saffron_100 = #colorLiteral(red: 1, green: 0.9490196078, blue: 0.8823529412, alpha: 1)
  ...
  static let green_100 = #colorLiteral(red: 0.8784313725, green: 1, blue: 0.9254901961, alpha: 1)
  static let green_200 = #colorLiteral(red: 0.662745098, green: 0.9450980392, blue: 0.768627451, alpha: 1)
  static let green_300 = #colorLiteral(red: 0.05098039216, green: 0.6, blue: 0.262745098, alpha: 1)
  static let green_400 = #colorLiteral(red: 0.03529411765, green: 0.4196078431, blue: 0.1843137255, alpha: 1)
...
extension UIColor {
    /// Initializes and returns a color object using the specified hexadecimal string and opacity.
    /// - Parameters:
    ///   - hex: The hexadecimal string to be converted into a color object. This can be a 3, 4, 6, or 8 digit hex code.
    ///   - opacity: The opacity value of the color object. The default is 1.0 (fully opaque).
    convenience init?(hex: String, opacity: CGFloat = 1.0) {
        ...
        case 3: // RGB (12-bit)
            (red, green, blue) = (
                CGFloat((hexValue & 0xF00) >> 8) / 15.0,
                CGFloat((hexValue & 0x0F0) >> 4) / 15.0,
                CGFloat(hexValue & 0x00F) / 15.0
            )
        case 6: // RGB (24-bit)
            (red, green, blue) = (
